...
<div class="controls">
    ...
    <div class="input-group-append d-flex justify-content-end mt-1">
        <button type="button" data-inputid="{{ $field['name'] }}-filemanager"
                class="btn btn-light btn-sm popup_selector mr-2"><i class="la la-cloud-upload"></i> Загрузить
        </button>
        <button type="button" data-inputid="{{ $field['name'] }}-filemanager"
                class="btn btn-light btn-sm clear_elfinder_picker"><i class="la la-eraser"></i> Удалить
        </button>
    </div>
</div>
